...
namespace X_Hackathon.Migrations
{
    ...
    [Migration("20241006064202_UpdatedMoreColumns")]
    partial class UpdatedMoreColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("X_Hackathon.Domain.CommercialInvoice", b =>
                {
                    ...
                    b.Property<string>("AWBNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "AWBNumber");
            ...
            modelBuilder.Entity("X_Hackathon.Domain.Product", b =>
                {
                    ...
                    b.Property<string>("ShippingInfo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "Shipping Info");
